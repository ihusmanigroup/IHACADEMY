// IH Academy — Backend Engineering Major Course (PRO Track #4)
    ...
    "modules": [
      {
        ...
        "objectives": ["Client/server architecture and the request lifecycle", "Async JavaScript: Promises and async/await", "Modules, npm and environment configuration"]
      },
      {
        "title": "Express, HTTP & REST APIs",
        "lessons": 10,
        ...
        "objectives": ["REST resource design and status codes", "Routing and middleware", "Controllers and response contracts"]
      },
      {
        "title": "MongoDB & Mongoose",
        "lessons": 10,
        ...
        "objectives": ["Schemas with validation and defaults", "CRUD with filtered and sorted queries", "Embedding vs referencing and indexes"]
      },
      {
        "title": "API Architecture, Validation & Errors",
        "lessons": 10,
        ...
        "objectives": ["Controllers/services/models separation", "Validation as a security boundary", "Centralized error middleware"]
      },
      {
        "title": "Authentication: Sessions & JWT",
        "lessons": 10,
        ...
        "objectives": ["Password hashing with bcrypt", "Session and JWT flows", "Secure cookie attributes"]
      },
      {
        "title": "Authorization, Security & Secure APIs",
        "lessons": 10,
        ...
        "objectives": ["Role and ownership checks", "401 vs 403", "Secrets, CORS and rate limiting"]
      },
      {
        "title": "Advanced REST APIs",
        "lessons": 10,
        ...
        "objectives": ["Query parsing and filtering", "Pagination with page-size caps", "Relationships and population"]
      },
      {
        "title": "Production Patterns, Testing & Reliability",
        "lessons": 10,
        ...
        "objectives": ["Folder structure and config validation", "Safe request logging", "Liveness vs readiness"]
      },
      {
        "title": "Real-World Business Logic",
        "lessons": 10,
        ...
        "objectives": ["State machines for orders and enrollments", "Idempotent order creation", "Consistency and failure handling"]
      },
      {
        "title": "Backend Integration & Capstone Engineering",
        "lessons": 10,
        ...
        "objectives": ["Endpoint and data model planning", "Auth planning per workflow", "Acceptance checklist"]
      }
    ]
  }
}
