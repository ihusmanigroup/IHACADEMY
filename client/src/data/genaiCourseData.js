// ---------------------------------------------------------------------------
// IH Academy — Generative AI Engineering Major Course (PRO Track #2)
// Exact same schema as mlCourseData.js (Course 1) so the shared viewer,
// roadmap engine, and progress tracking work without modification.
// 10 modules · 95 lessons · 20-question grand quiz · 3 capstone projects.
// ---------------------------------------------------------------------------

export const genAIMajorCourse = {
  "id": "genai-major-course",
  "title": "Generative AI Engineering Major Course",
  "subtitle": "Complete Beginner → Advanced Applied Generative AI (LLMs)",
  "badge": "MAJOR COURSE",
  "level": "Advanced",
  "duration": "24 hours",
  "tags": [
  ...
  "description": "Master Generative AI end-to-end: from Python and math foundations to the Transformer architecture, Hugging Face transformers, prompt engineering, fine-tuning with LoRA/PEFT, RAG over vector databases, and autonomous LLM agents. You finish with three portfolio capstones: a domain-specific RAG assistant, a fine-tuned specialist LLM, and a tool-using ReAct agent.",
  "overview": [
    "Foundations: Python, NumPy, Pandas, and the linear algebra / probability / calculus behind LLMs.",
    "Core theory: how Transformers work — attention, tokenization, embeddings, and positional encoding.",
    "Applied practice: Hugging Face transformers, prompt engineering, fine-tuning with PEFT/LoRA, RAG with vector databases, and ReAct agents.",
    "Career path: debugging, deployment, monitoring, and three certificate-gated capstone projects."
  ],
  "ebook": {
    ...
    "modules": [
      {
        ...
        "objectives": ["Vectorized NumPy operations", "Pandas data preparation", "A reusable 5-step data pipeline"]
      },
      {
        "title": "Math Foundations for LLMs",
        "lessons": 9,
        ...
        "objectives": ["Attention math: Q, K, V and softmax", "Perplexity and evaluation metrics", "Gradient descent from scratch"]
      },
      {
        "title": "Introduction to Generative AI & LLMs",
        "lessons": 10,
        ...
        "objectives": ["Next-token prediction and decoding", "Temperature, top-k, top-p", "Run your first model"]
      },
      {
        "title": "Transformer Architecture Deep Dive",
        "lessons": 10,
        ...
        "objectives": ["Self-attention from scratch", "BPE tokenization", "Embeddings and positional encodings"]
      },
      {
        "title": "Hugging Face Transformers in Practice",
        "lessons": 9,
        ...
        "objectives": ["Load any pre-trained model", "Select models by task and license", "Production-style inference"]
      },
      {
        "title": "Prompt Engineering Mastery",
        "lessons": 9,
        ...
        "objectives": ["Five-layer prompt skeleton", "Few-shot and CoT prompting", "Prompt-injection defenses"]
      },
      {
        "title": "Fine-Tuning & PEFT",
        "lessons": 9,
        ...
        "objectives": ["Prompt vs RAG vs fine-tune decisions", "LoRA: low-rank updates", "Fine-tune with the Trainer"]
      },
      {
        ...
        "objectives": ["Sentence-transformers embeddings", "FAISS and vector indexes", "Chunk, embed, retrieve, answer"]
      },
      {
        "title": "LLM Agents & Tool Use",
        "lessons": 9,
        ...
        "objectives": ["The observe-reason-act loop", "ReAct with structured steps", "Safe tool dispatch and eval"]
      },
      {
        "title": "Capstone Prep & Career Paths",
        "lessons": 10,
        ...
        "objectives": ["Capstone scoping and milestones", "Log-driven LLM debugging", "Portfolio and interview prep"]
      }
    ]
  }
}
