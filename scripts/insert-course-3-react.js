/**
 * IH Academy — Course 3: React.js & Modern Web Apps
 * Loads rich 500+ word topic content from course-data/course-3.json
 *
 * Usage:
 *   node scripts/insert-course-3-react.js
 */
...
async function run() {
  ...
  const coursePath = path.join(__dirname, '..', 'course-data', 'course-3.json')
  if (!fs.existsSync(coursePath)) {
    console.error('  ❌ course-data/course-3.json not found.')
    process.exit(1)
  }
